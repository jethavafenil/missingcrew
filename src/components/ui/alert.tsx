...
export function Alert({ message, type = 'error', onClose, redirectTo = '/' }: AlertProps) {
  ...
  }, [isVisible, onClose, router, redirectTo])
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black bg-opacity-30">
      <div className={`w-full max-w-md mx-4 p-4 ${bgColor} border rounded-lg shadow-xl`}>
        <div className="flex items-start">
          ...
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                className="inline-flex rounded-md p-1.5 text-gray-500 hover:bg-opacity-25 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
