...
export default async function CrewHome() {
  // Load featured projects and crew similar to home page
  let projects: Project[] = []
  let crew: any[] = []  // TODO: Define proper type for crew profiles
  ...
  try {
    ...
    projects = dbProjects.map((project) => {
      ...
      const rawRoles = project.rolesNeeded
      ...
      const rawQuestions = project.questions
      ...
      const shootStart = project.shootStartDate
      const shootEnd = project.shootEndDate
      return {
        id: String(project.id ?? ''),
        projectName: String(project.projectName ?? ''),
        projectType: String(project.projectType ?? ''),
        rolesNeeded: (rolesNeeded as string[]) || [],
        shootStartDate: shootStart ? new Date(shootStart).toISOString() : '',
        shootEndDate: shootEnd ? new Date(shootEnd).toISOString() : '',
        location: String(project.location ?? ''),
        description: String(project.description ?? ''),
        questions: (questions as string[]) || [],
        employer: { user: { name: String(project.employer?.user?.name ?? '') } },
        _count: { applications: Number(project._count?.applications ?? 0) },
      } as Project
    })
    ...
    console.error('Error loading crew-home data:', err)
  }
  ...
  return (
    <RoleRedirect allowedRole="CREW" redirectTo="/employer-home">
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <div className="relative container mx-auto px-4 py-6 md:py-8 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex w-full justify-center items-center mb-4 md:mb-3">
              {/* Role toggle present on both pages, defaults to crew here */}
      ...
      <section className="py-8 md:py-12 bg-gradient-to-b from-white to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent mb-3 md:mb-4 px-2">Why Crew Choose MissingCrew</h2>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-3">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-indigo-600 uppercase tracking-wider">Opportunities</span>
              </div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent">Featured Projects Hiring Now</h2>
            </div>
      ...
      <section className="py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-flex items-center gap-2 mb-3">
              <div className="h-px w-8 bg-gradient-to-r from-transparent to-purple-600"></div>
              <span className="text-sm font-semibold text-purple-600 uppercase tracking-wider">Top Talent</span>
              <div className="h-px w-8 bg-gradient-to-l from-transparent to-purple-600"></div>
            </div>
            <h2 className="text-2xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-900 via-purple-900 to-indigo-900 bg-clip-text text-transparent px-2">Standout Crew</h2>
            <p className="text-sm md:text-base text-gray-600 px-4 mt-2">Explore some of the most sought‑after professionals</p>
          </div>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent mb-3 md:mb-4 px-2">How It Works</h2>
      ...
      <section className="py-8 md:py-10 bg-gradient-to-b from-indigo-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6 md:mb-8">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-900 via-purple-900 to-indigo-900 bg-clip-text text-transparent mb-2 px-2">Flexible Plans for Teams</h2>
